...
В репозитории только наши файлы. Всё стороннее (BepInEx, Doorstop, Mono)
...
Ранее перевод выполнялся сторонним плагином — сейчас он удалён, будет написана своя система.
...
> Ранее использовался сторонний плагин перевода — удалён, будет заменён кастомным решением.
