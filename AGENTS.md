...
- Текст UI настроек: aligned strings в resources.assets (`Settings.*` ключи NToolkit) + UTF-16 LE в Assembly-CSharp.dll (sub-опции Video-таба)
...
- **Settings.\* ключи** — NToolkit локализация: `Settings.Fullscreen → Fullscreen` (58 ключей в resources.assets)
