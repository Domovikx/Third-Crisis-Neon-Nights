...
- Текст диалогов: null-terminated ASCII в data-секции level0-15 + sharedassets0
- Текст UI настроек: aligned strings в resources.assets (`Settings.*` ключи NToolkit)
...
- **Settings.* ключи** — NToolkit локализация: `Settings.Fullscreen → Fullscreen` (57 ключей в resources.assets)
...
- **"Environment Effects", "Realtime Reflections", "Resolution Scaling"** — не найдены в билде как display text (возможно, другая версия игры)
